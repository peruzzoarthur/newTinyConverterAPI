...
import cryptoBackgroundImage from "../img/cryptoGradient.jpeg";
...
function Search() {
  ...
  return (
    ...
    >
      <section className="w-full md:max-w-[600px] p-4 flex flex-col text-center items-center justify-center md:px-10 lg:p-20 h-full lg:h-[880px] bg-white bg-opacity-20 backdrop-blur-lg drop-shadow-lg rounded text-slate-200">
        <div>
          <OnOffCrypto
        ...
        {cryptoEnabled && (
          <h1 className="text-1xl font-black text-yellow-300">
            Crypto Mode On
          </h1>
        )}
